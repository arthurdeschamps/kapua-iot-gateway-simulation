...
class UserGuideService {
  ...
  void _buildSteps(Tour guide) {
    ...
    guide.addStep('start',
      new StepOptions(
        title: 'Welcome !',
        text: 'Welcome to the simulation\'s dashboard. This UI is here to make you see '+
          'in a friendly format what data is being generated by the simulation '+
          'what is being sent to Kapua. You can also customize the simulation as will '+
          'and even restart it. Follow this guide for more explanation.',
        buttons: buttons
      )
    );
